...
function FindingRow({ finding, projectId, onVerify }: { finding: Finding; projectId: string; onVerify: () => void }) {
  return (
    <tr className="hover:bg-secondary/50 transition-colors">
      ...
      <td className="px-4 py-3 font-medium max-w-xs">
        <Link href={`/projects/${projectId}/findings/${finding.id}`} className="hover:text-primary transition-colors">
